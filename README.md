...
## 版本历史
- v4.0.0 |02-06-26: 使用生产者-消费者模型重构并行方法，提升性能和资源利用率。
- v3.1.1 | 02-05-26: 优化程序代码，使用全链路异步模式；修改进度条显示效果。
- v3.0.2 | 01-21-26: 更新项目依赖；应用新的代码样式。
- v3.0.0 | 12-21-25: 重构整个项目，使用分层架构和依赖注入，提升代码可维护性和可扩展性。
